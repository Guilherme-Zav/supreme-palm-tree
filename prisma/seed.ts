/**
 * Seed: pré-cadastra os dois nichos com o DNA da Campanha preenchido.
...
async function main() {
  // ── Nicho 1 — Loja de iPhones Semi-Novos ──────────────────────────────
  await prisma.niche.upsert({
    where: { slug: "iphones-seminovos" },
    update: {},
    create: {
  ...
  // ── Nicho 2 — App Fitness com IA ──────────────────────────────────────
  await prisma.niche.upsert({
    where: { slug: "app-fitness-ia" },
    update: {},
    create: {
      slug: "app-fitness-ia",
  ...
  console.log("✅ Seed concluído: 2 nichos com DNA da Campanha pré-preenchido.");
}
